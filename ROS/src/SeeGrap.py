...
def on_EVENT_LBUTTONDOWN(event, x, y, flags, param):
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        X=np.array([[ 1.46871627e-04, -2.41734374e-01, -1.64831144e-19],
        [-2.06885007e-01 , 9.23482868e-02 ,-3.28393351e-19],
        [-1.17289845e+02 , 1.23944517e+02 , 1.00000000e+00]])
        a=np.array([x,y,1],np.float)
        a=a@X
        print(a)
        cmd = ZUOBIAO()  
        cmd.X = a[0]
